...
import com.algos.structure.symboltable.FrequencyCounterUtil;
...
public class BinarySearchTreeTest {
    ...
    private BinarySearchTree<String, Integer> symbolTable;
    ...
    private BinarySearchTree<String, Integer> getSymbolTable() {
